...
contains
    ...
    subroutine s_mpi_bcast_user_inputs
        ...
        #:for VAR in [ 'cyl_coord', 'mpp_lim', 'mixture_err',                  &
            & 'alt_soundspeed', 'hypoelasticity', 'diffusion', 'parallel_io', 'rho_wrt',    &
        ...
        do i = 1, num_fluids_max
            ...
            call MPI_BCAST(fluid_pp(i)%W, 1, mpi_p, 0, MPI_COMM_WORLD, ierr)
        ...
        #:for VAR in [ 'pref', 'rhoref', 'R0ref', 'poly_sigma', 'Web', 'Ca', &
            ...
            & 'y_output%end', 'z_output%beg', 'z_output%end', 'small_num_dif' ]
