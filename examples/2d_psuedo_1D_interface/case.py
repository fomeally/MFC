    ...
    json.dumps(
        {
            ...
            # Patch 2 CO2 (under N2)
            "patch_icpp(2)%geometry": 3,
            "patch_icpp(2)%x_centroid": 0.5*Lx,
            "patch_icpp(2)%y_centroid": 0.25*Ly,
            "patch_icpp(2)%length_x": Lx,
            "patch_icpp(2)%length_y": 0.5*Ly,
            ...
            # Patch 3 Water (smeared with n2)
            "patch_icpp(3)%geometry": 27,
            "patch_icpp(3)%smoothen": "T",
            "patch_icpp(3)%smooth_patch_id": 1,
            "patch_icpp(3)%smooth_coeff": 4.6 / 8.0,
            "patch_icpp(3)%x_centroid": 0.25*Lx,
            "patch_icpp(3)%y_centroid": 0.75*Ly,
            "patch_icpp(3)%length_x": 0.5*Lx,
            "patch_icpp(3)%length_y": 0.5*Ly,
            "patch_icpp(3)%amplitude": 0.01*0.5*Ly,
            "patch_icpp(3)%wavelength": 0.5*Ly,
            ...
            # Patch 4 Water (smeared with n2)
            "patch_icpp(4)%geometry": 27,
            "patch_icpp(4)%smoothen": "T",
            "patch_icpp(4)%smooth_patch_id": 2,
            "patch_icpp(4)%smooth_coeff": 4.6 / 8.0,
            "patch_icpp(4)%x_centroid": 0.25*Lx,
            "patch_icpp(4)%y_centroid": 0.25*Ly,
            "patch_icpp(4)%length_x": 0.5*Lx,
            "patch_icpp(4)%length_y": 0.5*Ly,
            "patch_icpp(4)%amplitude": 0.01*0.5*Ly,
            "patch_icpp(4)%wavelength": 0.5*Ly,
            "patch_icpp(4)%alter_patch(2)": "T",
            "patch_icpp(4)%vel(1)": 0.0,
            "patch_icpp(4)%vel(2)": 0.0,
            "patch_icpp(4)%pres": p0,
            "patch_icpp(4)%alpha_rho(1)": 0.0,
            "patch_icpp(4)%alpha_rho(2)": 0.0,
            "patch_icpp(4)%alpha_rho(3)": rho0w,
            "patch_icpp(4)%alpha(1)": 0.0,
            "patch_icpp(4)%alpha(2)": 0.0,
            "patch_icpp(4)%alpha(3)": 1.0,
